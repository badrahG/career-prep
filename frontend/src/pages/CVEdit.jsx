              ...
              {certs.map(function(c, i) {
                return (
                  <div key={i} className="border border-slate-200 rounded p-5 mb-4 bg-slate-50">
                    ...
                    <div className="mt-3">
                      <label className="block text-sm font-semibold text-slate-700 mb-1.5">Гэрчилгээний файл <span className="text-slate-400 font-normal">(PDF, JPG, PNG — 10MB хүртэл)</span></label>
                      {c.file_url ? (
                        <div className="flex items-center gap-3">
