...
function Pulse({ className }) {
  return <div className={"animate-pulse bg-slate-200/70 rounded " + (className || "")}></div>;
}
        ...
        return (
          <div key={i} className="bg-white border border-slate-200 rounded p-5">
            <div className="flex items-start gap-3 mb-4">
              <Pulse className="w-12 h-12 rounded flex-shrink-0" />
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {[0, 1, 2, 3].map(function (i) {
        return (
          <div key={i} className="bg-white border border-slate-200 rounded p-5 space-y-3">
...
export function DetailSkeleton() {
  return (
    <div className="bg-white border border-slate-200 rounded p-8 space-y-5">
      <div className="space-y-2">
...
export function RowSkeleton({ count = 3 }) {
  ...
  return (
    <div className="space-y-2">
      {items.map(function (i) {
        return (
          <div key={i} className="bg-white border border-slate-200 rounded p-4 flex items-center gap-3">
...
export function QuestionSkeleton() {
  return (
    <div className="bg-white border-2 border-slate-200 rounded p-8 md:p-10 space-y-6" style={{ minHeight: "420px" }}>
