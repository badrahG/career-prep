    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col relative overflow-hidden">
      ...
      <nav className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
          ...
          <Link to="/login" className="text-sm text-gray-500 dark:text-gray-400 hover:text-violet-600 dark:hover:text-violet-400 font-medium transition">
            ← Нэвтрэх
          </Link>
        </div>
      </nav>
            ...
            {sent ? (
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                  Хэрэв <span className="font-semibold text-gray-800 dark:text-gray-200">{email}</span> хаяг бүртгэлтэй бол нууц үг сэргээх линкийг илгээлээ. Линкийн хүчинтэй хугацаа <strong>1 цаг</strong>.
                </p>
              ...
              <>
                <div className="mb-8">
                  <p className="text-xs text-violet-600 font-bold uppercase tracking-wider mb-2">Нууц үг сэргээх</p>
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Нууц үгээ мартсан уу?</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">И-мэйл хаяг</label>
                    <input
                      type="email"
                      value={email}
                      ...
                      className="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-xl text-sm focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
                      autoFocus
                    />
                  </div>
