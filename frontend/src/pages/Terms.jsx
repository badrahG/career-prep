    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 py-3 text-xs text-slate-500">
          ...
          <span className="text-slate-900 font-medium">Үйлчилгээний нөхцөл</span>
        </div>
      </div>
          ...
          <article className="lg:col-span-3">
            ...
            <div className="bg-white border border-slate-200 rounded">
              <div className="p-8 space-y-8">
                ...
                <section id="section-3" className="pt-6 border-t border-slate-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {[
                      ...
                      return (
                        <div key={i} className="flex items-start gap-2 bg-slate-50 border border-slate-200 rounded p-2.5">
                ...
                <section id="section-8" className="pt-6 border-t border-slate-200">
                  <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-3">
            ...
            <div className="mt-6 bg-white border border-slate-200 rounded p-5 flex items-center justify-between flex-wrap gap-3">
              <div>
                <p className="text-sm font-semibold text-slate-900">Нууцлалын бодлогыг харах</p>
                <p className="text-xs text-slate-500 mt-0.5">Бид таны мэдээллийг хэрхэн хамгаалдаг талаар уншина уу.</p>
              </div>
              <Link to="/privacy" className="px-4 py-2 border border-slate-300 text-slate-700 rounded text-sm font-semibold hover:bg-slate-50 transition whitespace-nowrap">
                Нууцлалын бодлого →
              </Link>
            </div>
          </article>
