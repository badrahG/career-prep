...
export default function ScholarshipForm() {
  ...
  if (notFound) {
    return <Layout><div className="p-5 md:p-6 flex flex-col items-center justify-center min-h-[60vh] gap-4"><p className="text-gray-500 text-sm">Тэтгэлэг олдсонгүй.</p><Link to="/scholarship" className="px-5 py-2.5 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-xl text-sm font-semibold hover:shadow-md transition">← Жагсаалт руу буцах</Link></div></Layout>;
  }
    ...
    <Layout>
      <div className="p-5 md:p-6 max-w-3xl">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-400 mb-5">
          ...
          <span>/</span>
          <span className="text-gray-600 font-medium">{isEdit ? "Засах" : "Шинээр нэмэх"}</span>
          {isEdit && <span className="ml-auto text-xs bg-amber-50 text-amber-700 border border-amber-200 px-2 py-0.5 rounded-lg font-medium">Засварлах горим</span>}
        </div>
            ...
            <div className="pt-4 border-t border-gray-100">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className={"text-xs px-2 py-0.5 rounded-lg font-medium border " +
                  (logoSource === "custom" ? "bg-violet-50 text-violet-700 border-violet-100" :
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start mt-2">
                <div className="md:col-span-2">
                  ...
                  <p className="text-xs text-gray-400 mt-1.5">Хоосон үлдээвэл бүртгүүлэх линкээс <span className="font-semibold">Clearbit</span>-ээр автоматаар татна.</p>
                </div>
                <div className="bg-gray-50 border border-gray-200 rounded-2xl p-4 flex flex-col items-center gap-2">
                  <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Урьдчилж харах</p>
                  <OrgLogo
                    ...
                    size="lg"
                  />
                  <p className="text-xs text-gray-600 font-medium text-center line-clamp-1">{form.organization || "Байгууллагын нэр"}</p>
                </div>
              </div>
            </div>

            <div className="flex justify-between pt-5 border-t border-gray-100">
              <Link to="/scholarship" className="px-5 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition">Цуцлах</Link>
